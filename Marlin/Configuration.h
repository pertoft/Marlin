...
#define STRING_CONFIG_H_AUTHOR "Per Abildgaard Toft" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10S BL-Touch"
...
#define PID_AUTOTUNE_MENU // Add PID Autotune to the LCD "Temperature" menu to run M303 and apply the result.
  ...
  // PTO CR10S - 195C
  // Recv:  bias: 106 d: 106 min: 192.61 max: 196.99 Ku: 61.70 Tu: 19.17
  // Recv:  Kp: 37.02 Ki: 3.86 Kd: 88.71
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // #define DEFAULT_bedKp 558.37 
  // #define DEFAULT_bedKi 109.94
  // #define DEFAULT_bedKd 708.99
 ...
 */
// PTO #define DEFAULT_ACCELERATION          575    // X, Y, Z and E acceleration for printing moves
...
// PTO: Bullseye offset: ALL_BLT_LEFT_X-48_Y-10_3.29
